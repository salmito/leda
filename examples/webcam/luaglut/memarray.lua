...
local ok = try_loading('memarray', 'so') or
           try_loading('memarray', 'bundle') or
           try_loading('memarray', 'bundle', '_') or
           try_loading('memarray', 'dll') or
           try_loading('memarray')

if not ok then
   print('Cannot load memarray ?!?')
end
